...
cover: '/static/images/websiteMaking.jpg'
coverCredit: 'Shane Aldendorff'
coverCreditLink: 'https://unsplash.com/photos/3AzL-IR3v7Y'
---
...
Next.js provides so many sane and require out of the box features it makes an excellent choice for developing React app or websites. But Next.js even with all it's "opinions" leaves the task of managing content to the user and this is where Contentlayer comes it. Both of them compliment each other and give an excellent DX for the developer and excellent UX of the user.